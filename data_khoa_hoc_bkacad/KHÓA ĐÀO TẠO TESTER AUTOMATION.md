...
![KHÓA ĐÀO TẠO TESTER AUTOMATION](images/course/2024/08/original/z5756115676735_5f7d1fb4c5f32143c33fc2ba846a511a_1724398711.jpg)
...
- Nắm được các kiến thức về kiểm thử tự động, lợi ích của kiểm thử tự động và các tình huống nên áp dụng kiểm thử tự động
- Giới thiệu cơ bản về Lập trình hướng đối tượng Java.
- Hướng dẫn tạo Project Maven Java, đọc ghi file, log file,..
- Giới thiệu và thực hành về Selenium.
- Giới thiệu và thực hành TestNG Framework.
- Giới thiệu và thực hành cách log và quản lý bug.
- Giới thiệu và thực hành cách quản lý Project bằng Git & GitHub.
- Giới thiệu và thực hành chạy Project Automation test

**Đối tượng:** 
- Các bạn sinh viên khoa CNTT các Đại học, Cao đẳng - Người đi làm hoặc sinh viên các ngành kỹ thuật có kiến thức cơ bản về CNTT - Đã biết cơ bản một số ngôn ngữ lập trình phổ biến: Java, C#, Python… là một lợi thế. - Kỹ sư kiểm thử phần mềm Manual đang m
...
* Git là gì? ([Git CSM](https://git-scm.com/))
* Ưu điểm của Git
* Dịch vụ Git ([GitHub](https://github.com/))
* Các bước cài đặt để sử dụng được Git trên Windows
* Cách đẩy source code lên GitHub với [Tortoisegit](https://tortoisegit.org/download/)
...
Liên hệ hỗ trợ việc làm và chính sách hỗ trợ học phí **[tại đây](https://bkacad.edu.vn/dang-ky-hoc.html)**
