...
![KHÓA HỌC ĐÀO TẠO LẬP TRÌNH VIÊN BACK END – JAVA SPRING BOOT & AI](images/course/2025/09/original/backend-ai_1758857850.jpg)
...
Học viên được trang bị kiến thức và kỹ năng để tích hợp hiệu quả một số giải pháp AI vào dự án backend, tối ưu hóa hiệu suất và nâng cao chất lượng ứng dụng.

**Đối tượng:** 
Các bạn sinh viên, người đi làm có định hướng nghề nghiệp trở thành lập trình viên Backend sử dụng Java, Springboot, Spring AI. Không yêu cầu kiến thức đầu vào
...
* Nắm được kiến thức cơ bản về AI và ứng dụng thông qua công nghệ Spring AI
...
- Cơ hội nghề nghiệp, việc làm với Backend SpringBoot, Spring AI.
...
**Module 4: Spring AI (15h)**

* **Kiến thức cơ bản:**
* **+** Tổng quan về AI, Large Language Model (LLMs)
* + Tổng quan về Spring AI và OpenAI: Giới thiệu, Tạo và cấu hình OpenAPI trong Spring, Sử dụng lệnh và các chức năng cơ bản.
* + Prompt engineer: Phân loại các prompt (Zero shot, few shot, chain of thought), công thức prompt tối ưu
* + Tạo sinh hình ảnh bằng Spring AI và OpenAI
* + Spring AI Text to Speech
* **Kiến thức nâng cao:**
* + Retrieval Augmented Generation (RAG): Giới thiệu kiến trúc RAG và vector store.
* **Thực hành:**

+ Xây dựng ứng dụng RAG cơ bản kết hợp với Spring AI

**Module** **5****: Triển khai trong môi trường Docker (10h)**
...
**Module** **6****: Project thực tế (30h)**

Học viên học với dự án thực tế tại trung tâm phần mềm BKSOFT của BKACAD.
