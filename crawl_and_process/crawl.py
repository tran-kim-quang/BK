...
def save_to_markdown_file(title, url, content, page_count):
        ...
        try:
            ...
            for header in course_headers:
                ...
                if link_tag:
                    ...
                    if content_md:
                        save_to_markdown_file(title, full_link, content_md, page_count)
                        total_files += 1
